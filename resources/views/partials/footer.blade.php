        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    ...
                    <p>All Site Content TM and 2020 DC Entertainment, unless <span>noted here</span>. All rights reserved.<br><span>Cookies Settings</span></p>
                </div>
                <div class="col-6">
                    <div>
                        <img src="{{ Vite::asset('resources/img/dc-logo-bg.png') }}" alt="Facebook">
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center py-4">
                        ...
                        <div>
                            <ul class="d-flex align-items-center gap-2">
                                <li class="blue-follow">FOLLOW US</li>
